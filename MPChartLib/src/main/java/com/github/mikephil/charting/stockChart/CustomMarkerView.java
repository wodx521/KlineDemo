...
public class CustomMarkerView extends MarkerView {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        tvTime.setText(kLineDataModel.getDateMills());
        tvOpen.setText(NumberUtils.keepPrecision(kLineDataModel.getOpen(), precision));
        tvHighest.setText(NumberUtils.keepPrecision(kLineDataModel.getHigh(), precision));
        tvLowest.setText(NumberUtils.keepPrecision(kLineDataModel.getLow(), precision));
        tvClose.setText(NumberUtils.keepPrecision(kLineDataModel.getClose(), precision));
        float upDownAmount = kLineDataModel.getClose() - kLineDataModel.getOpen();
        float upDownRatio = upDownAmount / kLineDataModel.getOpen() * 100;
        ...
        tvTradeAmount.setText(NumberUtils.keepPrecision(kLineDataModel.getVolume(), precision));
        tvHoldAmount.setText("0");
