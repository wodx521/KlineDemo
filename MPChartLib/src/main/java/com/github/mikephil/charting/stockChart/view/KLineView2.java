 ...
 * K线view
 */
public class KLineView2 extends BaseView {
    ...
    public void initChart(boolean landscape) {
        ...
        candleChart.setHighlightFullBarEnabled(false);
    ...
    public void setDataToChart(KLineDataManage data) {
        ...
        candleChartData.setData(candleData);
        LineData lineData = new LineData(kLineData.getLineDataMA());
        lineData.setHighlightEnabled(true);
        candleChartData.setData(lineData);
...
//                break;
    ...
    public void setMarkerView(KLineDataManage kLineData) {
        ...
        Animation animationHide = AnimationUtils.loadAnimation(mContext, R.anim.popup_hide_anim);
        Animation animationShow = AnimationUtils.loadAnimation(mContext, R.anim.popup_show_anim);

        customMarkerView.setAnimation(animationShow);
    ...
    public void updateText(int index, boolean isSelect) {
        ...
        Float aFloat5 = kLineData.getKmaEntity5().getMAs().get(index);
        Float aFloat10 = kLineData.getKmaEntity10().getMAs().get(index);
        Float aFloat20 = kLineData.getKmaEntity20().getMAs().get(index);
        if (aFloat5.isNaN()) {
            aFloat5 = 0f;
        }
        ...
        candleChart.setDescriptionCustom(zbColor, new String[]{"MA5:" + (aFloat5 == 0 ? "--" : NumberUtils.keepPrecision(aFloat5, 2)), "MA10:" + (aFloat10 == 0 ? "--" :NumberUtils.keepPrecision(aFloat10, 2)), "MA20:" + (aFloat20 == 0 ? "--" :NumberUtils.keepPrecision(aFloat20, 2))});
        chartSwitch(index);
    }
